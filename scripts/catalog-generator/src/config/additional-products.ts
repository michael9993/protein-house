...
export const ACCESSORIES_PRODUCTS: ProductDefinition[] = [
  { type: "accessories", brand: "Nike", model: "Brasilia Backpack", model_he: "תיק גב ברסיליה", gender: "Unisex", category: "men-tops", material: "Polyester", productType: "Bag", basePrice_ILS: 149, basePrice_USD: 40, collections: ["nike"] },
  { type: "accessories", brand: "Adidas", model: "Classic Backpack", model_he: "תיק גב קלאסי", gender: "Unisex", category: "men-tops", material: "Polyester", productType: "Bag", basePrice_ILS: 129, basePrice_USD: 35, discount: 0.15, collections: ["adidas", "sale"] },
  { type: "accessories", brand: "Under Armour", model: "Hustle Backpack", model_he: "תיק גב האסל", gender: "Unisex", category: "men-tops", material: "Polyester", productType: "Bag", basePrice_ILS: 179, basePrice_USD: 48, collections: ["under-armour"] },
  { type: "accessories", brand: "Nike", model: "Futura Cap", model_he: "כובע פיוצ'רה", gender: "Unisex", category: "men-tops", material: "Cotton", productType: "Hat", basePrice_ILS: 89, basePrice_USD: 24, collections: ["nike", "best-sellers"] },
  { type: "accessories", brand: "Adidas", model: "Baseball Cap", model_he: "כובע בייסבול", gender: "Unisex", category: "men-tops", material: "Cotton", productType: "Hat", basePrice_ILS: 79, basePrice_USD: 21, collections: ["adidas"] },
  { type: "accessories", brand: "Puma", model: "Essentials Cap", model_he: "כובע אסנשלס", gender: "Unisex", category: "men-tops", material: "Cotton", productType: "Hat", basePrice_ILS: 69, basePrice_USD: 19, discount: 0.20, collections: ["puma", "sale"] },
  { type: "accessories", brand: "Nike", model: "Everyday Cushion Socks (3 Pack)", model_he: "גרביים קושן (3 זוגות)", gender: "Unisex", category: "men-tops", material: "Cotton", productType: "Socks", basePrice_ILS: 59, basePrice_USD: 16, collections: ["nike"] },
  { type: "accessories", brand: "Adidas", model: "Cushioned Crew Socks (3 Pack)", model_he: "גרביים (3 זוגות)", gender: "Unisex", category: "men-tops", material: "Cotton", productType: "Socks", basePrice_ILS: 49, basePrice_USD: 13, collections: ["adidas"] },
  { type: "accessories", brand: "Nike", model: "HyperCharge Water Bottle", model_he: "בקבוק מים היפרצ'רג'", gender: "Unisex", category: "men-tops", material: "Plastic", productType: "Water Bottle", basePrice_ILS: 79, basePrice_USD: 21, collections: ["nike"] },
  { type: "accessories", brand: "Under Armour", model: "Sideline Squeeze Bottle", model_he: "בקבוק מים סייד לייט", gender: "Unisex", category: "men-tops", material: "Plastic", productType: "Water Bottle", basePrice_ILS: 69, basePrice_USD: 19, collections: ["under-armour"] },
];
