# PowerShell script to create a tunnel for the SMTP app
# This allows external access to your local SMTP app for webhook testing
...
Write-Host "Creating tunnel for SMTP app on port $Port using $Tool..." -ForegroundColor Green
...
if ($Tool -eq "cloudflared") {
    ...
    Write-Host "Your SMTP app will be accessible at the URL shown below" -ForegroundColor Yellow
