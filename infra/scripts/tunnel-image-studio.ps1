# PowerShell script to create a tunnel for the Image Studio app
# This allows external access to your local Image Studio app for webhook testing
...
Write-Host "Creating tunnel for Image Studio app on port $Port using $Tool..." -ForegroundColor Green
...
if ($Tool -eq "cloudflared") {
    ...
    Write-Host "Your Image Studio app will be accessible at the URL shown below" -ForegroundColor Yellow
