# PowerShell script to create a tunnel for the Bulk Manager app
# This allows external access to your local Bulk Manager app for webhook testing
...
Write-Host "Creating tunnel for Bulk Manager app on port $Port using $Tool..." -ForegroundColor Green
...
if ($Tool -eq "cloudflared") {
    ...
    Write-Host "Your Bulk Manager app will be accessible at the URL shown below" -ForegroundColor Yellow
