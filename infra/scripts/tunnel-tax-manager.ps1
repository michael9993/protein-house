# PowerShell script to create a tunnel for the Tax Manager app
# This allows external access to your local Tax Manager app for webhook testing
...
Write-Host "Creating tunnel for Tax Manager app on port $Port using $Tool..." -ForegroundColor Green
...
if ($Tool -eq "cloudflared") {
    ...
    Write-Host "Your Tax Manager app will be accessible at the URL shown below" -ForegroundColor Yellow
