# PowerShell script to create a tunnel for the Stripe app
...
Write-Host "Creating tunnel for Stripe app on port $Port using $Tool..." -ForegroundColor Green
...
if ($Tool -eq "cloudflared") {
    ...
    Write-Host "Your Stripe app will be accessible at the URL shown below" -ForegroundColor Yellow
