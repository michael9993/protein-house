...
export const ProductDetailTextSchema = z.object({
  ...
  sizeGuideDogsTab: z.string().optional(),            // "Dogs"
  sizeGuideCatsTab: z.string().optional(),           // "Cats"
  sizeGuideHowToMeasure: z.string().optional(),      // "How to Measure"
  sizeGuideMeasureTip: z.string().optional(),        // "Measure your pet's back length..."
  sizeGuideProTip: z.string().optional(),            // "Pro Tip: Measure when your pet is standing..."
  sizeGuideClothingCategory: z.string().optional(), // "Clothing"
  sizeGuideCollarsCategory: z.string().optional(),  // "Collars & Harnesses"
  sizeGuideBedCategory: z.string().optional(),      // "Beds"
  sizeGuideClothingMeasureTip: z.string().optional(), // "Measure your pet's back length..."
  sizeGuideClothingProTip: z.string().optional(),     // "Pro Tip: If between sizes, choose the larger..."
