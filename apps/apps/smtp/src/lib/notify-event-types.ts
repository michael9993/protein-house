...
export type NotifySubscriptionPayload = {
  ...
  | {
      notify_event: "abandoned_checkout";
      payload: NotifyPayloadAbandonedCheckout;
    }
  | {
  ...
  | {
      notify_event: "newsletter_subscribe";
      payload: NotifyPayloadNewsletterSubscribe;
    }
  | {
...
export interface NotifyPayloadAbandonedCheckout {
  channel_slug: string;
  checkout_id: string;
  currency: string;
  domain: string;
...
interface AbandonedCheckoutLine {
  id: string;
  product_name: string;
  variant_name: string;
  product_sku: string;
...
export interface NotifyPayloadNewsletterSubscribe {
  channel_slug: string;
  domain: string;
  email: string;
  logo_url: string;
