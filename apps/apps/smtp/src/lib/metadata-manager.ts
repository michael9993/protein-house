...
const _updateAppMetadataDoc = gql`
...
void _updateAppMetadataDoc;

const _fetchAppDetailsDoc = gql`
...
void _fetchAppDetailsDoc;

const _deleteAppMetadataDoc = gql`
