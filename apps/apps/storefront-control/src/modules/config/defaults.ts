...
const getFallbackDefaultConfig = (channelSlug: string): StorefrontConfig => ({
  ...
  footer: {
    ...
    accessibilityDefaultContent: "",
    accessibilityFooter: "",
    vatStatement: "All prices include 18% VAT",
    showVatStatement: true,
  ...
  homepage: {
    sections: {
      ...
      hero: {
        ...
        secondaryCtaText: "Explore Our Deals",
        secondaryCtaLink: "/products?sale=true",
        showTagline: true,
        taglineText: "New Season",
        showStats: false,
        stat1Value: "",
        stat1Label: "",
        stat2Value: "",
  ...
  ui: {
    ...
    floatingButtons: {
      ...
      scrollToTop: { enabled: true, side: "end", order: 1 },
      gap: 0.75,
      baseOffset: 7,
    },
  },
  ...
  content: {
    ...
    faq: {
      ...
      heroDescription: "Find answers to frequently asked questions about orders, shipping, returns, and more.",
      searchPlaceholder: "Search for answers...",
      categoriesLabel: "Categories",
      resultsLabel: "{count} result(s) for \"{query}\"",
      noResultsText: "No results found. Try a different search term or",
      contactUsLink: "contact us",
      stillHaveQuestionsTitle: "Still Have Questions?",
      stillHaveQuestionsDescription: "Our support team is available 24/7 to help you out.",
      contactUsButton: "Contact Us",
      ...
      categories: [
        {
          ...
          icon: "📦",
          items: [
            { question: "How long does shipping take?", answer: "Standard shipping takes 3-5 business days. Express shipping is available for 1-2 business day delivery. International orders typically arrive within 7-14 business days." },
            { question: "Do you offer free shipping?", answer: "Yes! We offer free standard shipping on all orders over $75." },
            { question: "Can I track my order?", answer: "Once your order ships, you'll receive an email with tracking information. You can also track your order in your account." },
        ...
        },
        {
          ...
          icon: "🔄",
          items: [
            { question: "What is your return policy?", answer: "We offer a 30-day return policy on all unused items in their original packaging." },
            { question: "How do I return an item?", answer: "Log into your account, go to your order history, and select 'Return Item'. You'll receive a prepaid shipping label via email." },
            { question: "Are returns free?", answer: "Returns are free within the continental US. For international returns, customers are responsible for return shipping costs." },
            ...
            { question: "Can I exchange an item for a different size?", answer: "Yes! We offer free exchanges for different sizes. Initiate a return and place a new order for the size you need." },
          ],
        },
        {
          name: "Products",
          icon: "🏃",
          items: [
            { question: "Are all products authentic?", answer: "100% yes! We are an authorized retailer for all brands we carry." },
            { question: "How do I find my size?", answer: "Each product page includes a detailed size guide. We recommend measuring yourself and comparing to our charts." },
            { question: "Do you offer product warranties?", answer: "Many of our products come with manufacturer warranties. Details are listed on individual product pages." },
        ...
        },
        {
          ...
          icon: "🔒",
          items: [
            { question: "What payment methods do you accept?", answer: "We accept all major credit cards, PayPal, Apple Pay, Google Pay, and Shop Pay." },
            ...
            { question: "Do you offer financing options?", answer: "Yes! We offer buy-now-pay-later options. At checkout, you can split your purchase into 4 interest-free payments." },
            { question: "When will I be charged?", answer: "Your payment method is charged when you place your order." },
          ],
        },
        {
          name: "Account & Orders",
          icon: "👤",
          items: [
            { question: "Do I need an account to place an order?", answer: "No, you can checkout as a guest. However, creating an account allows you to track orders and save addresses." },
            ...
            { question: "Can I view my order history?", answer: "Yes! Log into your account and click on 'Order History' to view all your orders." },
            { question: "How do I unsubscribe from emails?", answer: "Click the 'Unsubscribe' link at the bottom of any marketing email." },
          ],
        },
      ],
    },
