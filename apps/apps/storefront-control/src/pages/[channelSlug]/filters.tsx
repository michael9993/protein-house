      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          >
            ...
            />
            <Box>
              <Text>Enable Product Filters</Text>
              <Text size={2} color="default2">
                Show filter sidebar on product listing pages
              </Text>
            </Box>
          </Box>

          <Text as="h4" marginBottom={3}>
            Individual Filters
          </Text>
        ...
        >
          ...
          >
            ...
            />
            <Box>
              <Text>Enable Quick Filters</Text>
              <Text size={2} color="default2">
                Show visual filter cards above product grid
              </Text>
            </Box>
          </Box>

          <Text as="h4" marginBottom={3}>
            Show Quick Filters For
          </Text>
