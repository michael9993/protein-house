    ...
    <Box>
        ...
        {steps.map((s, idx) => (
          <Box key={s.key} display="flex" alignItems="center" gap={2}>
            <Box
              ...
              __color={idx <= currentStepIndex || step === "complete" ? "white" : colors.textLight}
              __fontSize="14px"
              __fontWeight="600"
            >
            ...
            <Text
              ...
              __color={idx === currentStepIndex ? colors.text : colors.textLight}
            >
              {s.label}
            </Text>
            {idx < steps.length - 1 && (
              <Box
                __width="40px"
                __height="2px"
                __backgroundColor={idx < currentStepIndex ? "#22c55e" : colors.border}
              />
            )}
          </Box>
        ))}
        ...
        <Box>
          ...
          <Box display="flex" gap={6} marginBottom={6}>
            ...
            >
              ...
              <Text size={2} __color={colors.textMuted} __display="block">
                Valid rows
              </Text>
            </Box>
            <Box
            ...
            <Box
              ...
              __flex="1"
            >
              <Text size={6} __fontWeight="700" __color={colors.brand}>
      ...
      {step === "complete" && executeResults && (
        <Box>
          ...
          {executeResults.results.some((r) => r.success && (r.error || r.warning)) && (
            <Box marginBottom={4}>
              ...
              <Box borderRadius={4} __border="1px solid #fde68a" __backgroundColor="#fffbeb" padding={3}>
                {executeResults.results
                  .filter((r) => r.success && (r.error || r.warning))
                  .map((r) => (
