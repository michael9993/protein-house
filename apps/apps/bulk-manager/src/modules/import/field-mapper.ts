...
const fieldMappingRules: Record<string, Record<string, string[]>> = {
  ...
  categories: {
    ...
    backgroundImageUrl: ["backgroundimageurl", "background_image", "background_image_url", "image_url", "image", "banner", "banner_url"],
    backgroundImageAlt: ["backgroundimagealt", "background_image_alt", "image_alt", "banner_alt"],
  },
  collections: {
    ...
    productSKUs: ["product_skus", "product_sku_list", "product skus", "productskus"],
    ...
    backgroundImageUrl: ["backgroundimageurl", "background_image", "background_image_url", "image_url", "image", "banner"],
    backgroundImageAlt: ["backgroundimagealt", "background_image_alt", "image_alt", "banner_alt"],
  },
  customers: {
  ...
  translations: {
    slug: ["slug", "url_key", "url key", "handle"],
    sku: ["sku", "variant_sku", "variant sku", "item_number", "item number"],
    name: ["name", "product_name", "product name", "productname", "translated_name", "translation_name"],
    description: ["description", "desc", "product_description", "product description", "translated_description"],
    seoTitle: ["seo_title", "meta_title", "page_title", "seotitle", "seo title", "meta title"],
    seoDescription: ["seo_description", "meta_description", "seodescription", "seo description", "meta description"],
    variantName: ["variant_name", "variant name", "variantname", "translated_variant"],
  },
  giftCards: {
...
const sampleRows: Record<string, Record<string, string>> = {
  products: {
    ...
    description: "Durable braided rope toy for dogs, great for tug-of-war and fetch",
    ...
    quantityLimit: "",
    color: "Blue",
    imageUrl: "https://example.com/images/rope-toy-blue.jpg",
    brand: "Pawzen",
    seoTitle: "Interactive Rope Toy for Dogs",
    seoDescription: "Shop the Interactive Rope Toy — durable and fun for all dog sizes",
    taxClass: "standard",
    ...
    imageUrl4: "",
    imageUrl5: "",
    imageAlt: "Interactive Rope Toy Blue",
    variantWeight: "",
  ...
  categories: {
    ...
    parent: "dogs",
    seoTitle: "Dog Toys - Pawzen",
    seoDescription: "Browse our dog toys collection",
    metadata: "featured:true",
    externalReference: "CAT-001",
    backgroundImageUrl: "https://example.com/images/dog-toys-banner.jpg",
    backgroundImageAlt: "Dog toys collection banner",
  },
  collections: {
    name: "Summer Sale 2025",
    slug: "summer-sale-2025",
    description: "Hot summer deals on selected pet products",
    products: "",
    seoTitle: "Summer Sale - Up to 50% Off",
    seoDescription: "Shop our summer sale collection",
    productSlugs: "interactive-rope-toy;orthopedic-dog-bed",
    productSKUs: "",
    isPublished: "Yes",
