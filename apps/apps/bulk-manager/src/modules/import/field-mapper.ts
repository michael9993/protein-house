...
const fieldMappingRules: Record<string, Record<string, string[]>> = {
  products: {
    ...
    isPublished: ["is_published", "published", "visible", "status"],
    visibleInListings: ["visible_in_listings", "show_in_listings", "visible in listings"],
    chargeTaxes: ["charge_taxes", "taxable", "charge taxes"],
  ...
  collections: {
    ...
    products: ["products", "product_ids", "product ids", "product_slugs"],
    seoTitle: ["seo_title", "meta_title", "page_title", "seotitle"],
    seoDescription: ["seo_description", "meta_description", "seodescription"],
    productSlugs: ["product_slugs", "product_handles", "product slugs", "product handles"],
    productSKUs: ["product_skus", "product_sku_list", "product skus"],
    isPublished: ["is_published", "published", "visible"],
    metadata: ["metadata", "custom_fields", "meta"],
    externalReference: ["external_reference", "external_id", "source_id"],
