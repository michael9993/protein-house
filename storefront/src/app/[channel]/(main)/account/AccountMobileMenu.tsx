...
export function AccountMobileMenu({ channel }: AccountMobileMenuProps) {
	...
	const isSettingsActive = pathname === `/${channel}/account/settings` || pathname.startsWith(`/${channel}/account/settings`);

	return (
		<div className="lg:hidden mt-6 rounded-xl bg-white shadow-sm ring-1 ring-neutral-100 animate-fade-in-up" style={{ animationDelay: "250ms", animationFillMode: "both" }}>
