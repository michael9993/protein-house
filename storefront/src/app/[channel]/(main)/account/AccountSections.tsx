      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <h3 className="text-lg font-semibold text-neutral-900">My Orders</h3>
      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <h3 className="text-lg font-semibold text-neutral-900">My Addresses</h3>
            <p className="mt-1 text-sm text-neutral-500">
              {addressesCount} address{addressesCount !== 1 ? "es" : ""} saved
            </p>
          </div>
          <svg className="h-5 w-5 text-neutral-400 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
