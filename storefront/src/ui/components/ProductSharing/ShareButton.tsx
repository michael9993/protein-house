...
export function ShareButton({
  ...
  return (
    <>
      ...
      <Drawer.Root open={showModal} onOpenChange={setShowModal} direction="bottom">
        <Drawer.Portal>
          <Drawer.Overlay className="fixed inset-0 z-[9998] bg-black/50" />
          <Drawer.Content
            className="fixed inset-x-0 bottom-0 z-[9999] mx-auto flex max-h-[85dvh] flex-col rounded-t-2xl bg-neutral-50 outline-none sm:inset-x-4 sm:bottom-4 sm:max-w-md sm:rounded-2xl"
            style={{
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              <div className="grid grid-cols-5 gap-3">
                <button
                  ...
                  className="flex flex-col items-center gap-1.5 rounded-xl p-3 transition-colors hover:bg-neutral-100"
                >
                  ...
                  <span className="text-[10px] font-medium text-neutral-600">Facebook</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] font-medium text-neutral-600">Twitter</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] font-medium text-neutral-600">Pinterest</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] font-medium text-neutral-600">WhatsApp</span>
                </button>
              ...
              {/* Copy Link */}
              <div className="mt-4 flex gap-2 rounded-xl border border-neutral-200 bg-white p-1.5">
                <input
                  type="text"
                  value={resolvedUrl}
                  readOnly
                  className="min-w-0 flex-1 truncate bg-transparent px-2.5 py-2 text-sm text-neutral-600 outline-none"
                  onClick={(e) => {
                    e.stopPropagation();
                ...
                <button
                  ...
                  style={{ backgroundColor: copied ? "#16a34a" : "#171717" }}
                >
                  {copied ? "Copied!" : "Copy"}
                </button>
              </div>
