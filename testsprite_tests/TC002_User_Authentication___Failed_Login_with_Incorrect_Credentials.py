...
async def run_test():
    ...
    try:
        ...
        # -> Click on the user menu or 'Sign In' link to navigate back to the login page to retry invalid login.
        frame = context.pages[-1]
        # Click the user menu to find the Sign In or login option to navigate back to login page.
        elem = frame.locator('xpath=html/body/header/div[2]/div/div/div[2]/nav/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click the 'Sign Out' button to log out and return to the login page for retrying invalid login.
        frame = context.pages[-1]
        # Click the 'Sign Out' button to log out and return to the login page.
        elem = frame.locator('xpath=html/body/header/div[2]/div/div/div[2]/nav/div/div[2]/div/div[4]/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click the 'Sign In' link to navigate to the login page for retrying invalid login.
        frame = context.pages[-1]
        # Click the 'Sign In' link to navigate to the login page.
        elem = frame.locator('xpath=html/body/header/div[2]/div/div/div[2]/nav/div/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Input invalid username and password into the login form and click the Sign In button.
        frame = context.pages[-1]
        # Input invalid email address
        elem = frame.locator('xpath=html/body/div/main/div/div/div[2]/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('michaelzaher1993@gmail.com')
