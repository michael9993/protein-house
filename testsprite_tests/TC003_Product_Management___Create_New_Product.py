...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click Sign In tab to refresh login form
        ...
        # -> Try to clear cookies or cache and retry login or try alternative login methods such as Google login.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test case failed: Admin user was unable to create a new product with variants, attributes, pricing, and inventory details as per the test plan.")
