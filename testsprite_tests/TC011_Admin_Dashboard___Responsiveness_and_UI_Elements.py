...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the admin dashboard page to start UI validation on desktop.
        frame = context.pages[-1]
        # Click on 'Sign In' to access login for admin dashboard
        elem = frame.locator('xpath=html/body/header/div[2]/div/div/div[2]/nav/div/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input the provided username and password, then submit the login form to access the admin dashboard.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test case failed: The admin dashboard UI did not render correctly or is not responsive across desktop and mobile devices as per the test plan.')
